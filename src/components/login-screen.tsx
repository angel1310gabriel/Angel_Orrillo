    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-emerald-50/30 to-teal-50/40 p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">KC Cobranzas</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Sistema de Gestión de Cobranzas</p>
        </div>

        {/* Login Card */}
        <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100 dark:border-slate-800 p-6 sm:p-8">
          <div className="mb-6">
            <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100">Iniciar Sesión</h2>
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Ingrese su DNI, correo o celular</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Error Message */}
            {error && (
              <div className="bg-red-50 dark:bg-red-950/50 border border-red-200 rounded-lg px-4 py-3">
