                ...
                <Table>
                  <TableHeader>
                    <TableRow className="bg-emerald-50 dark:bg-emerald-950/50">
                      <TableHead className="text-xs font-semibold text-emerald-700 dark:text-emerald-300 uppercase">#</TableHead>
                      <TableHead className="text-xs font-semibold text-emerald-700 dark:text-emerald-300 uppercase">Vencimiento</TableHead>
                      <TableHead className="text-right text-xs font-semibold text-emerald-700 dark:text-emerald-300 uppercase">Monto</TableHead>
                      <TableHead className="text-center text-xs font-semibold text-emerald-700 dark:text-emerald-300 uppercase">Estado</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                    {schedule
                    ...
                    <TableRow className="bg-emerald-50 dark:bg-emerald-950/70 font-bold">
