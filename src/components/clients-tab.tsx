...
{c.stats.activeLoans>0&&<Button className="h-8 w-8 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white border-0" size="icon" onClick={()=>{window.location.href='?tab=payments'}}><DollarSign className="h-4 w-4"/></Button>}
